...
import 'package:movie_app/src/containers/add_available.dart';
import 'package:movie_app/src/containers/available_list.dart';
            ...
            children: <Widget>[
              ...
              ChooseType(
                ...
                onOptionTap: (CategoryOption value) {
                  setState(() {
                    for (final CategoryOption element in animalTypes) {
                      type = value.type;
